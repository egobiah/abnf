...
class Rule(_Rule):
    ...
    grammar = [
            ...
            'dmarc-tag = *WSP (dmarc-request / dmarc-srequest / dmarc-auri / dmarc-furi / dmarc-aspf / dmarc-adkim / dmarc-aspf / dmarc-ainterval / dmarc-fo / dmarc-percent / dmarc-rfmt) *WSP'
        ]
